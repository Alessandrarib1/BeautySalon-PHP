...
<div>
    ...
    <div class="container flex-wrap justify-content-center ">
        ...
        <br>
        <br>
        <form class="form" method="post" action="/updateAppointment">
            <div class="col-6">
                ...
                <select name="employee" class="form-select">
                    ...
                    <input class="form-control" name="dateOfAppointment" type="date"
                    ...
                    <input class="form-control" type="time" name="startingTime"
                           value="<?= $appointment->startingTime ?>"> <br> <br>
                    <label for="Name: ">Name: </label>
                    <input class="form-control" type="text" name="name" value="<?php echo $appointment->customerName ?>"
